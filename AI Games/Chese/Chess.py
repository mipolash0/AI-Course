...
def ai_move(board):
    # To make the AI easier, we reduce the depth of the minimax search.
    # A depth of 1 means the AI only looks one move ahead.
    _, move = minimax(board, 1, -math.inf, math.inf, False) # Changed depth from 2 to 1
    if move:
        board.push(move)
